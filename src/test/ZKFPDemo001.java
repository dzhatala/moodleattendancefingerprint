...
public class ZKFPDemo001 extends JFrame{
	/**
	 * 
	 */
	...
	public void launchFrame(){
		...
		this.setTitle("ZKFingerSDK Demo 001");
...
*/
		...
		public void actionPerformed(ActionEvent e) {
			...
			sizeFPTemp[0] = 2048;
//			int ret = FingerprintSensorEx.ExtractFromImage( mhDB, path, 500, fpTemplate, sizeFPTemp);	
//			String path1="G:\\rsync\\RESEARCHS\\moodle\\eclipse\\javaws\\moodle_att_https\\tpl\\TPL9_6.tpl";
			String path1="G:\\rsync\\RESEARCHS\\moodle\\eclipse\\javaws\\moodle_att_https\\tpl\\TPL10_6.tpl";
...
//				fpTemplate=Files.readAllBytes(nf.toPath());
				...
				System.out.println("tpl length:"+nf.length());
...
//			FingerprintSensorEx.Int2ByteArray(1, paramValue1);
			...
			paramValue1 = ByteBuffer.allocate(4).putInt(0).array();
			FingerprintSensorEx.SetParameters(mhDevice, 102, paramValue1, 4);
